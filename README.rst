...
.. image:: https://img.shields.io/badge/license-Apache--2.0-blue.svg
    ...
    :target: https://github.com/bechtoldt/saltstack-php-formula/blob/master/LICENSE

.. image:: https://img.shields.io/badge/gitter-chat-brightgreen.svg
    :alt: Join Chat
    :target: https://gitter.im/bechtoldt/saltstack-php-formula?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge

SaltStack Formula to set up and configure PHP, a scripting language that is especially suited to web development
...
Take a look at older `releases <https://github.com/bechtoldt/saltstack-php-formula/releases>`_ to get a version that isn't using the formhelper
yet (if any).
...
But it’s better to `file an issue <https://github.com/bechtoldt/saltstack-php-formula/issues/new>`_ with your idea first.
